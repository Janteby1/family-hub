...
export default function ListsPage() {
  ...
  return (
    <div className="p-4 md:p-8">
      <h1 className="mb-6 text-2xl font-semibold text-neutral-900">Lists</h1>

      <section className="mb-6 rounded-xl border border-neutral-200 p-4">
        <h2 className="mb-3 font-medium text-neutral-900">New list</h2>
          ...
          {lists.map((list) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-neutral-500">{uncheckedCounts[list.id] ?? 0} left</span>
              </div>
            </Link>
          ))}
        </div>
